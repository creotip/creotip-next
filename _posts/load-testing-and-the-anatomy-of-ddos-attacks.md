...
- [An introduction to DDoS attack ( distributed denial-of-service attack)](<#an-introduction-to-ddos-attack-(distributed-denial-of-service-attack)>)
  - [DDoS mechanism](#ddos-mechanism)
  - [How is malware distributed?](#how-is-malware-distributed)
  - [How innocent internet users are exploited for DDoS attacks](#how-innocent-internet-users-are-exploited-for-ddos-attacks)
  - [IoT devices are vulnerable to hackers](#iot-devices-are-vulnerable-to-hackers)
  - [Dos and DDoS methods of execution](#dos-and-ddos-methods-of-execution)
- [What is Load Testing and Load Generator?](#what-is-load-testing-and-load-generator)
- [Load testing with ddosify](#load-testing-with-ddosify)
- [Load testing as a DDoS attack simulation](#load-testing-as-a-ddos-attack-simulation)
  - [Scheduling the load testing with at command](#scheduling-the-load-testing-with-at-command)
  - [Using crontab to schedule the load testing](#using-crontab-to-schedule-the-load-testing)
  ...
  "steps": [
    {
      ...
      "headers": {
        ...
        "x-csrf-token": "DB1RRbtvDeKrJCw25X2orqovE5e2YnZgvWpfvCQ6vUXelHdXQJpyZOMxvgy12O9uaymO+nA6fFenWbRUAOPvpw==",
        "cookie": "_secretdomain_session=RThhMm5scGhzcXlUMDlUb2w1TGc2bXoxQ3JSTTcxMXcxcmdRZWxDcXVrNnpNVHc3REY0YUNGQll3YjEwZHhUVUlxK1F0Z005a1VrMTVUMzlramFjTHcxUGZOdi9Hd1E3K2h1QVBuREtXODJ3RUZXa3c5NHFMc2kwRzROUXpMV0txVS9ZMytLUVJaUlVhaXZReFVMSGtRPT0tLTJpOEdDZlVPaWpwSHNDTDRVT0RZYVE9PQ%3D%3D--076304873ff53ead16def293db0c4349905d23c7; crisp-client%2Fsession%2F6a4a83f5-2991-4055-9980-307cf3d01be0=session_d69103f0-b733-4275-ba19-f187f5492bbd",
